...
*/}}
{{- define "hedgedoc.volumePermissions.image" -}}
...
*/}}
{{- define "hedgedoc.ingress.certManagerRequest" -}}
...
*/}}
{{- define "hedgedoc.validateValues" -}}
{{- $messages := list -}}
{{- $messages := append $messages (include "hedgedoc.validateValues.foo" .) -}}
{{- $messages := append $messages (include "hedgedoc.validateValues.bar" .) -}}
